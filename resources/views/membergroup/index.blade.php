                        ...
                        <li class="flex justify-between gap-x-6 py-5">
                          <div class="flex min-w-0 gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                              <p class="text-md font-semibold leading-6 text-gray-900">{{ $value->group_name }}</p>
                              <p class="mt-1 truncate text-xs leading-5 text-gray-500">{{ $value->created_at }}</p>
                            </div>
                          </div>
                          <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                            <p class="text-sm leading-6 text-gray-900"><a href="{{ route('membergroup.edit', $value->id) }}" class="border border-yellow-500 hover:bg-yellow-500 hover:text-white px-4 py-2 rounded-md">EDIT</a></p>
                            <br>
